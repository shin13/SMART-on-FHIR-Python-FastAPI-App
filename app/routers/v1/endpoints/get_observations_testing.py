...
# async def extract_height(fhir_josn):
#     # Bundle
#     if fhir_josn.get("resourceType") == "Bundle" and fhir_josn.get("total", 0) > 0:
#         try:
#             entry = fhir_josn["entry"][0]["resource"]
#             value = entry.get("valueQuantity", {}).get("value")
#             unit = entry.get("valueQuantity", {}).get("unit")
...
#     # Single 
#     try:
#         value = fhir_josn.get("valueQuantity", {}).get("value")
#         unit = fhir_josn.get("valueQuantity", {}).get("unit")
...
# async def extract_weight(fhir_josn):
#     # Bundle
#     if fhir_josn.get("resourceType") == "Bundle" and fhir_josn.get("total", 0) > 0:
#         try:
#             entry = fhir_josn["entry"][0]["resource"]
...
# async def extract_bmi(fhir_josn):
#     # Bundle
#     if fhir_josn.get("resourceType") == "Bundle" and fhir_josn.get("total", 0) > 0:
#         try:
#             entry = fhir_josn["entry"][0]["resource"]
...
# async def get_smoking_status(tokens):
#     # Getting data in the way prescribed by OAuthLib package
#     uri, headers, body = client.add_token(
